...
libmm-venc-inc      += $(TOP)/device/xiaomi/sm6225-common/hals/media/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += device/xiaomi/sm6225-common/hals/media/mm-core/inc
libmm-venc-inc      += device/xiaomi/sm6225-common/hals/media/libstagefrighthw
libmm-venc-inc      += device/xiaomi/sm6225-common/hals/media/libplatformconfig
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += device/xiaomi/sm6225-common/hals/media/libc2dcolorconvert
