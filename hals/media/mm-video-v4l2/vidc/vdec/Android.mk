...
libmm-vdec-inc          += $(TOP)/device/xiaomi/sm6225-common/hals/media/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/device/xiaomi/sm6225-common/hals/media/mm-core/inc
libmm-vdec-inc          += device/xiaomi/sm6225-common/hals/media/libplatformconfig
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/adreno
libmm-vdec-inc      	+= $(TOP)/device/xiaomi/sm6225-common/hals/media/libc2dcolorconvert
...
libmm-vdec-inc += $(TOP)/device/xiaomi/sm6225-common/hals/media/libstagefrighthw
endif
